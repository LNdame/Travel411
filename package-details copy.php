...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Lake -Malawi</h1>
	</div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
...
<div  class="container" style="width: 600px; ">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel" style="width: 600px; ">
    ...
    <div class="carousel-inner">
      ...
      <div class="item <?php echo $i == 0 ? 'active': '';  ?>">
        <img src="admin/pacakgeimages/<?php echo htmlentities($rsimg->PackageImage); ?>" alt="Los Angeles" ">
      </div>
